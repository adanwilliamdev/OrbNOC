    ...
    <div className="min-h-screen bg-gradient-to-br from-[#070b17] via-[#0b1220] to-[#070b17]">
      ...
      >
        <button
          ...
          className={`px-4 py-2 bg-slate-700/80 hover:bg-slate-600 text-slate-300 hover:text-white rounded-lg text-sm font-medium transition-all duration-300 flex items-center gap-2 backdrop-blur-sm shadow-lg border border-slate-600/70 ${
      ...
      <div className="h-screen flex flex-col p-8">
        <div className="text-center mb-12">
          <h1 className="text-6xl font-bold bg-gradient-to-r from-blue-300 to-indigo-400 bg-clip-text text-transparent">
            OrbNOC Wallboard
          </h1>
          <p className="text-xl text-slate-400 mt-2">Network Operations Center</p>
        </div>

        <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="text-center">
            <div className="text-9xl font-bold text-emerald-300">{online}</div>
            <p className="text-3xl text-slate-300 mt-2">ONLINE</p>
          </div>
          <div className="text-center">
            <div className="text-9xl font-bold text-blue-300">{availability}%</div>
            <p className="text-3xl text-slate-300 mt-2">DISPONIBILIDADE</p>
          </div>
          <div className="text-center">
            <div className="text-9xl font-bold text-rose-400">{offline}</div>
            <p className="text-3xl text-slate-300 mt-2">OFFLINE</p>
          </div>
        </div>
        ...
        <footer className="mt-4 pt-4 border-t border-slate-600/70 text-center text-xs text-slate-400">
          OrbNOC Network Operations Center © 2026 • Desenvolvido por <span className="text-blue-300">Adan W O Santos</span>
          <br />
          <span className="text-slate-500">Mova o mouse para o canto superior direito para sair</span>
        </footer>
      </div>
    </div>
  );
